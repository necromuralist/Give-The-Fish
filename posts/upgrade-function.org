...
#+begin_notecard
[[https://fishshell.com/docs/current/cmds/type.html][type]] checks how a name would be interpreted (=function=, =bultin=, or =file= ). It returns 0 if it isn't defined. =query= suppresses the output.
#+end_notecard
